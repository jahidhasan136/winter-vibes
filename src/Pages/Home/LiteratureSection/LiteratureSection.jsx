...
const LiteratureSection = () => {
    return (
        <div className="mt-[60px] md:mt-[120px] container mx-auto p-5">
            <div className='md:flex items-center grid gap-[20px] md:gap-[76px] justify-center mx-auto' data-aos="fade-up"
            ...
            <div className='mt-[38px] md:flex justify-center items-center' data-aos="fade-up"
                data-aos-anchor-placement="bottom-bottom">
