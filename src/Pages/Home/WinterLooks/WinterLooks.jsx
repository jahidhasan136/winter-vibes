...
const WinterLooks = () => {
    return (
        <div className="mt-[120px] container mx-auto">
            <h1 className='text-[42px] font_caprasimo mb-[10px]'><span className='font_caprasimo bg-clip-text text-transparent bg-gradient-to-b from-[#722CFF] to-[#A346EF]'>Winter</span> Day Looks</h1>
            <div>
                <div className='relative'>
                    <img className='mb-6' src={product1} alt="" />
                    <button className='bg-[#313131] text-white absolute bottom-0 rounded-b-[20px] w-[267px] py-[5px] flex items-center justify-center gap-5'><img src={moneyIcon} alt="" /> Add to Card</button>
