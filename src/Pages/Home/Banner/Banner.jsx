    ...
    return (
        <div className='container mt-[35px] md:mt-[99px] mx-auto md:flex justify-between p-5'>
            ...
            <div className='relative mt-12 md:mt-0'>
                ...
                <img src={model} alt="" />
                <img className='absolute -bottom-10 md:bottom-36 2xl:bottom-0 right-0' src={bg_half} alt="" />
                <p className='flex items-center gap-2 md:gap-[13px] text-lg bg-[white] shadow-xl shadow-[#4c099033] absolute px-3 md:px-5 md:py-[13px] rounded-[40px] bottom-3 md:bottom-48 2xl:bottom-12 right-4 md:-right-16 h-12 md:w-[156px] font-medium'><img src={star} alt="" /> Favorite</p>
                <p className='flex items-center absolute gap-4 md:gap-8 text-lg font-medium bg-[white] shadow-xl shadow-[#4c099033] px-5 py-[17px] rounded-[40px] bottom-10 md:bottom-52 2xl:bottom-20 -left20 h-12 md:w-[195px]'><AiOutlineBars className='text-[#8033FB]'></AiOutlineBars> Categories</p>
                <div className='absolute bottom-0 md:bottom-44 2xl:bottom-3 left-9 -z-10 bg-cover bg-no-repeat w-[158px] h-[158px]' style={{ backgroundImage: `url(${bg_circle})` }}></div>
            </div>
        </div>
    );
};
