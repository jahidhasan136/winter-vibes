...
const Banner = () => {
    return (
        <div className='container mt-[99px] mx-auto flex justify-center gap-[38px]'>
            <div className='w-1/2'>
                ...
                <div className='flex items-center'>
                    <button className="btn_custom">Start Shoping</button>
            ...
            <div className='relative'>
                ...
                <p className='flex items-center gap-[13px] text-lg bg-[white] shadow-sm absolute px-5 py-[13px] rounded-[40px] bottom-28 -right-16 h-12 w-[156px] shadow-[#4c099033] font-medium'><img src={star} alt="" /> Favorite</p>
                <p className='flex items-center absolute gap-8 text-lg font-medium bg-[white] shadow-sm px-5 py-[17px] rounded-[40px] bottom-40 -left20 h-12 w-[195px] shadow-[#4c099033]'><AiOutlineBars className='text-[#8033FB]'></AiOutlineBars> Categories</p>
